...
export function Services() {
  return (
    <section id="services" className="px-8 md:px-12 py-32 bg-[#0c0c0c]">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {services.map((service, i) => (
            <article
              key={service.title}
              data-reveal
              className="group border border-white/10 bg-black/40 p-8 hover:border-[#C8A45D]/50 transition-colors"
            >
